...
For `CLAUDE.md`, report a separate 3-field probe instead: `exists`, `has_pointer_block` (`<mktux-ai-context>` present), `foreign_blocks` (list of tag names found, plus `<name>` for each `<!-- name:start -->` pair).
